...
var ranks = []Rank{
	...
	},
	{
		...
		Salary: 100_000,
		eligibleForPromotion: func(player *Player) bool {
			return player.Money >= 20_000_000
		},
	},
	{
		Name:   "Staff Miner",
		Salary: 250_000,
		eligibleForPromotion: func(player *Player) bool {
			return player.Money >= 50_000_000
		},
	},
	{
	...
	},
	{
		...
		Salary: 1_000_000,
		eligibleForPromotion: func(player *Player) bool {
			return player.Money >= 100_000_000_000_000
		},
	},
	{
		Name:   "Mythic Miner",
